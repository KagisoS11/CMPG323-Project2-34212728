...
namespace EcoPowerLogistics_Project2_API.Controllers
{
    ...
    public class OrderDetailsController : ControllerBase
    {
        ...
        public OrderDetailsController(EcoPowerLogistics_Project2_APIContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<OrderDetails>> PostOrderDetails(OrderDetails orderDetails)
        {
          if (_context.OrderDetails == null)
          {
              return Problem("Entity set 'EcoPowerLogistics_Project2_APIContext.OrderDetails'  is null.");
          }
