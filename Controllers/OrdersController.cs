...
namespace EcoPowerLogistics_Project2_API.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        public OrdersController(EcoPowerLogistics_Project2_APIContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Orders>> PostOrders(Orders orders)
        {
          if (_context.Orders == null)
          {
              return Problem("Entity set 'EcoPowerLogistics_Project2_APIContext.Orders'  is null.");
          }
        ...
        [HttpPatch("{id}")]
        public async Task<IActionResult> UpdateOrders(int id, Orders order)
        {
            if (id != order.OrderID)
            {
                return BadRequest();
